...
import ChatBox from "../../Components/Saler/ChatBox";

export default function SalerChat() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 h-[96vh] max-h-[96vh]">
      {/* Sidebar */}
      <div className="lg:col-span-1 bg-white border-r shadow-sm flex flex-col rounded-xl border-gray-200">
      ...
      {/* Chat content */}
      <div className="lg:col-span-3 bg-white h-[96vh] max-h-[96vh]  flex flex-col rounded-xl shadow-sm">
        {openChat ? (
          <ChatBox
            roomId={openChat}
