...
import { StatsCard } from "../../Components/Saler/StatsCard";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <StatsCard title="Phòng" value={12} />
        <StatsCard title="Đẵ Đặt" value={10} />
        <StatsCard title="Doanh Thu" value="12.340.000 VNĐ" />
        <StatsCard title="Người Xem" value={2.256} />
      </div>
