...
const Header = () => {
  ...
  const handleLocationChange = (e) => {
    ...
    // TODO: điều hướng hoặc filter theo khu vực
    ...
    <nav className="fixed top-4 left-4 right-4 z-50
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex-1 flex space-x-6 justify-end">
          <a href="/register" className="hover:text-blue-700 text-blue-500 hidden md:flex">Đăng Kí</a>
          <a href="/login" className="hover:text-blue-700 text-blue-500 hidden md:flex">Đăng nhập</a>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4">
          <ul className="text-blue-500 space-y-3 text-lg">
            ...
            <li><a href="/login" className="block hover:text-blue-700">Đăng nhập</a></li>
          </ul>
        </div>
      )}
    </nav>
